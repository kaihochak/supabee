...
## Known follow-ups
- [x] Detect the latest common cutoff from backtick-wrapped migration-list cells while retaining plain ASCII/Unicode support and rejecting malformed versions.
